...
Organizar a informação para dispositivos móveis é um desafio, e por isso deve ser feito primeiro; Não somente no design, mas também de arquitetura de software.  Menus dropdown, o floating button ou o famoso menu drawer do material design foram criados para solucionar problemas de poluição visual em dispositivos móveis.
